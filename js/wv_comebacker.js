...
(function () {
    ...
    class Comebacker {
        constructor() {
            ...
            this.offers = [
                ...
                },
                {
                    offer_id: 223,
                    offer_name: 'Prostatricum',
                    offer_image: 'https://minio.cdnwv.com/cdnwv/success/it/223/success-product.png',
                },
            ];
        }
        getLanguage() {
        ...
        createComebacker() {
            ...
            let modifyStyle = '';
            if (this.offer_currency == 'CHF' || this.offer_currency == 'CZK' || this.offer_currency == 'PLN' || this.offer_currency == 'CLP') {
            ...
            comebackerSection.innerHTML = `
                ...
                <div class="wv_comebacker__container">
                    ...
                    <div class="wv_comebacker__content">
                        ...
                        <a href="${this.landing_url}" target="_blank" class="wv_comebacker__link">
                            ${this.button}
                        </a>
                    </div>
                </div>
